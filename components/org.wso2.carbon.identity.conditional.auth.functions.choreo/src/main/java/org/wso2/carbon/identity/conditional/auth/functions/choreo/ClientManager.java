...
public class ClientManager {
    ...
    private static final int HTTP_CONNECTION_TIMEOUT = 100;
    private static final int HTTP_READ_TIMEOUT = 100;
    private static final int HTTP_CONNECTION_REQUEST_TIMEOUT = 100;
